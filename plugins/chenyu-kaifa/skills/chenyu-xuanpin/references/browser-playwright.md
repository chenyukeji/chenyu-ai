...
J 使用卖家精灵“选产品”页面，而非 Amazon 新品榜。按站点选择“近60天”上架、“FBM”配送、最低预估月销量后回读页面控件和查询参数，保存原始结果、采集页与筛选条件；随后以记录中的实际日期、配送方式和销量再次核验。登录/验证码受限时停止；游客可见结果或分页截断应标记部分覆盖，不声称全站穷尽。站外流量和功能创新不从标题、价格或销量推断。
